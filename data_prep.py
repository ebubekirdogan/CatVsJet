...
# klasor yollari
    ...
    print(f"Sınıflar(Etiketler): {train_dataset.classes}") # ImageFolder sinifinin otomatik olarak cikarttigi sinif listesi.
    print(f"Egitim: {len(train_dataset)} resim | Test: {len(test_dataset)} resim hazir") # train dataset icindeki resim sayisini yazdiriyoruz

    return train_loader, test_loader # model egitim dosyasında cagirilacak.
