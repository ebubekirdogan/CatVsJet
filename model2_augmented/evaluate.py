...
def evaluate_model():
    ...
    print("========== TEST SONUCLARI (Model 2 - Augmented) ==========")
    ...
    with open('results/metrics_model2_augmented.txt', 'w', encoding='utf-8') as f:
        f.write("Model 2 - Augmented Test Sonuclari\n")
    ...
    plt.title('Confusion Matrix - Model 2 (Augmented)')
    ...
    plt.tight_layout()
    plt.savefig('results/confusion_matrix_model2_augmented.png')
    ...
    history = torch.load('history_model2_augmented.pth', weights_only=False)
    ...
    plt.tight_layout()
    plt.savefig('results/loss_accuracy_curves_model2_augmented.png')
    plt.close()
